							...
							<div class="col-lg-7">
								<div class="edit-checkout-head">
									...
									<div class="breadcrumb-area">
										<ul>
											<li><a class="active" href="shop-cart.php">Cart</a><i class="fa fa-angle-right"></i></li>
								...
								<div class="edit-checkout-information">
									...
									<div class="edit-checkout-form">
										...
										<div class="row row-gutter-12">
											...
											<div class="col-12">
												<div class="btn-box">
													<a class="btn-shipping" href="shop.php">Continue to shipping</a>
													<a class="btn-return" href="cart.php">Return to cart</a>
												</div>
											</div>
										</div>
									</div>
