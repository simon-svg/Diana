...
<body>
    <?php require_once "blog/index.php" ?>

    <div class="admin">
        <?php
        $navArr = ["index.php", "home.php", "contact.php", "subscribe.php", "#", "productCategory.php", "productColor.php",
                ...
                <div class="admin__contact">
                    <table class="admin__table">
                        <tr>
                            ...
                            <th class="admin__table_title">text</th>
                        ...
                        foreach ($result as $res) { ?>
                            <tr class="admin__section_item">
                                ...
                                <td class="admin__section_item_td">
                                    <h3 class="admin__section_item_pos"><?php echo $res->text ?></h3>
                                </td>
                                <td class="admin__section_item_td">
