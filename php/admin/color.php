...
<body>
    <?php require_once "color/index.php" ?>
    ...
    <div class="admin">
        ...
        <div class="admin__section admin__section_header-list">
            <div class="admin__section_head">
                <h3 class="admin__section_title">Color</h3>
            </div>
            <div class="admin__section_content">
                        ...
                        foreach ($result as $res) { ?>
                            <tr class="admin__section_item">
                                ...
                                <td class="admin__section_item_td">
                                    ...
                                    <a href="Color/querys.php?id=<?php echo $res->id ?>">
                ...
                ?>
                <form class="admin__form" action="Color/querys.php" method="POST">
                    ...
                    <div>
                        <button class="btn custom-btn admin__form_btn" name="submit">Add Color</button>
                    </div>
                </form>
            </div>
        </div>
