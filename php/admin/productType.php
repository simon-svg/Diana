...
<body>
    <?php require_once "productType/index.php" ?>

    <div class="admin">
        <?php
        $navArr = ["index.php", "home.php", "contact.php", "subscribe.php", "blog.php", "productCategory.php",
        "productColor.php", "#", "productSize.php", "productTag.php"];
        ...
        <div class="admin__section admin__section_header-list">
            <div class="admin__section_head">
                <h3 class="admin__section_title">Product Type</h3>
            </div>
            <div class="admin__section_content">
                        ...
                        foreach ($result as $res) { ?>
                            <tr class="admin__section_item">
                                ...
                                <td class="admin__section_item_td">
                                    ...
                                    <a href="productType/querys.php?id=<?php echo $res->id ?>">
                ...
                ?>
                <form class="admin__form" action="productType/querys.php" method="POST">
                    ...
                    <div>
                        <button class="btn custom-btn admin__form_btn" name="submit">Add Product Type</button>
                    </div>
                </form>
            </div>
        </div>
