    ...
    <div class="admin">
        ...
        <div class="admin__section admin__section_header-list">
            <div class="admin__section_head">
                <h3 class="admin__section_title">blog</h3>
            </div>
            <div class="admin__section_content">
                <form class="admin__form" action="querys.php" method="POST" enctype="multipart/form-data">
                    <div class="form__flex">
                        <input class="admin__inp admin__inp_header form-control" type="text" name="title" placeholder="Title" required>
                        
                        <textarea class="admin__inp admin__inp_header form-control" type="text" name="text" placeholder="Text" required></textarea>
