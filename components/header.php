      ...
      <div class="col">
        <div class="header-navigation-area">
          <ul class="main-menu nav">
            <li class="has-submenu"><a href="index.php"><span>Home</span></a></li>
            <li class="has-submenu full-width"><a href="shop.php"><span>Shop</span></a></li>
            <li class="has-submenu"><a href="#/"><span>Pages</span></a>
              <ul class="submenu-nav">
                <li><a href="shop-size-chart.php">Size chart</a></li>
                <li><a href="shop-shipping-policy.php">Shipping policy</a></li>
                <li><a href="about.php">About</a></li>
              </ul>
            </li>
            <li class="has-submenu"><a href="blog.php"><span>Blog</span></a></li>
